@echo off
rem Daily Mavat new-plan discovery sweep (scheduled task: MavatDiscovery).
...
venv\Scripts\python.exe -u mavat_discover_units.py --limit 150 >> discovery_last.log 2>&1
